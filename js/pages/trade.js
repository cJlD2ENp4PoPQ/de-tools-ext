...
const TradeExtension = {
  ...
  artArtis: ['Agsora', 'Geabwus', 'Auctagon', 'Artascendus', 'Sekkollus','Pesara','Geangrus','Creditrüssel','Pekasch','Vakara','Empdestro','Recarion','Empala','Turla','Pekek','Tronicar','Feuroka','Bloroka','Recadesto','Turak','Waringa'],
