const kolliPoints = {0:10000,1:10500,2:11000,3:11500,4:12000,5:12500,6:13000,7:13500,8:14000,9:14500,10:15000,11:15500
...
const SekExtension = {
  ...
  addFleetpoints : function (content) {
    let players = [];
    let playerCounter = 0;
    let fpc_cols = content.querySelectorAll("td.text2,td.text3").forEach((node, i) => {
      if(i%2 === 0) {
